...
Version  : 1.0.1
Release  : 16
URL      : file:///aot/build/clearlinux/packages/modpackages/modpackages-v1.0.1.tar.gz
Source0  : file:///aot/build/clearlinux/packages/modpackages/modpackages-v1.0.1.tar.gz
Summary  : Custom python scripts for managing Clear Linux packages
Group    : Development/Tools
License  : GPL-2.0 MIT
Requires: modpackages-bin = %{version}-%{release}
Requires: modpackages-python = %{version}-%{release}
Requires: modpackages-python3 = %{version}-%{release}
Requires: mypy
...
%package bin
Summary: bin components for the modpackages package.
Group: Binaries

%description bin
bin components for the modpackages package.


%package python
Summary: python components for the modpackages package.
Group: Default
Requires: modpackages-python3 = %{version}-%{release}

%description python
python components for the modpackages package.


%package python3
Summary: python3 components for the modpackages package.
Group: Default
Requires: python3-core

%description python3
python3 components for the modpackages package.


%prep
%setup -q -n modpackages
cd %{_builddir}/modpackages
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631098440
